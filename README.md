...
[![build-ublue](https://github.com/dajix350/sericiafx-nvidia/actions/workflows/build.yml/badge.svg)](https://github.com/dajix350/sericiafx-nvidia/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `dajix350/sericiafx-nvidia` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/dajix350/sericiafx-nvidia:20230403
```
